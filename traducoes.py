...
TRANSLATIONS = {
    ...
    "Guia visual das medições": "Visual measurement guide",
    "Identifique no desenho as dimensões tf, D, H e F antes de medir.": "Use the drawing to identify dimensions tf, D, H and F before measuring.",
    "Dimensões do flange, estojo e porca (ilustração esquemática).": "Flange, stud and nut dimensions (schematic illustration).",
    "O desenho neste idioma estará disponível em breve.": "The drawing for this language will be available soon.",
